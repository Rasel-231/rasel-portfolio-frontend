  ...
  return (
    <footer className="relative w-full overflow-hidden  text-white border-t border-white/5">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden opacity-70">
        ...
        <div className="absolute top-1/2 left-1/3 w-80 h-80 bg-indigo-600/5 blur-[100px] rounded-full"></div>
        <div className="absolute bottom-0 right-1/4 w-80 h-80 bg-purple-600/5 blur-[100px] rounded-full"></div>
      </div>

      {/* Main Content Container */}
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-12 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
          
          {/* Logo and Description Column */}
          <div className="col-span-full mb-10 lg:col-span-2 lg:mb- backdrop-blur-md p-6 ">
            <a href="#" className="flex justify-center lg:justify-start">
              <svg width="180" height="40" viewBox="0 0 180 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <text x="50" y="28" fontFamily="'Segoe UI', Tahoma, Geneva, Verdana, sans-serif" fontSize="24" fontWeight="bold" fill="currentColor" className="fill-white">
                  RaselHub
                </text>
              </svg>
            </a>
            <p className="py-6 text-sm text-slate-400 lg:max-w-xs text-center lg:text-left leading-relaxed">
              Trusted in more than 100 countries & 5 million customers. Have any query?
            </p>
            <a
              href="#"
              className="py-2.5 px-6 h-10 flex items-center justify-center w-fit bg-gradient-to-r from-indigo-600 to-purple-600 rounded-full shadow-lg text-xs font-semibold text-white mx-auto transition-all duration-300 hover:from-indigo-500 hover:to-purple-500 lg:mx-0 shadow-indigo-600/10"
            >
              Contact us
            </a>
          </div>
          ...
          {Object.entries(footerLinks).map(([title, links]) => (
            <div key={title} className="lg:mx-auto text-left pt-2">
              <h4 className="text-base text-white font-semibold mb-6 capitalize tracking-wide">
                {title}
              </h4>
        ...
        {/* Bottom Bar */}
        <div className="py-7 border-t border-white/5 relative z-10">
          <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row gap-4">
            <span className="text-sm text-slate-400 text-center lg:text-left">
              ©{" "}
            ...
            <div className="flex space-x-4 sm:justify-center">
              {socialLinks.map((link) => (
                <a
                  ...
                  className="w-9 h-9 rounded-full bg-slate-900 border border-white/5 flex justify-center items-center hover:bg-gradient-to-r hover:from-indigo-600 hover:to-purple-600 hover:border-transparent transition-all duration-300"
                >
                  {link.icon}
                </a>
              ))}
